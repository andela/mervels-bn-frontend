...
describe('Request One Way Trip', () => {
    beforeEach(() => {
        ...
        wrapperWithAutofill = shallow(<MultiCityRequest autofill autofillInfo={{}} getLocations={jest.fn()} history={{ push: jest.fn() }} requestTrip={jest.fn()} />);
        wrapperWithAutofillInfo = shallow(<MultiCityRequest autofill autofillInfo={autofillInfo} getLocations={jest.fn()} history={{ push: jest.fn() }} requestTrip={jest.fn()} />);
    });
