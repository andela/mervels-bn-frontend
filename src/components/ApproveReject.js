...
class ApproveReject extends Component {
    constructor(props) {
        super(props);
        this.state = {request: null, error: undefined, submitting:{sub1: '', sub2: ''}, dropDisplay: 'hidden', arrowDirection: 'right', dropActive: false, reason: 'Comment/ reason'};
    }
    ...
    render() { 
        ...
        <div className="grid single-request-container">
            ...
            <div className={`trv-reason trv-reason-dropdown ${dropDisplay}`}>
                ...
                <textarea className="trv-reason txt-reason-comment" onChange={this.handleChange} value={reason}/>
