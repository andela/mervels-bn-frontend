...
export class ReturnRequest extends React.Component {
    ...
    render() {
        const { from, location, travelDate, accommodation, reason, error, possibleLocations,returnDate, passportName, passportNumber, gender, markup, updating, submitting } = this.state;
        const {
            locationIds,
            locationNames,
